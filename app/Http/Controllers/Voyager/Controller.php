            ...
            case 'file':
                if ($files = $request->file($row->field)) {
                    ...
                    foreach ($files as $key => $file) {
                    	...
                    	$jpg = ends_with($file->getClientOriginalName(), '.jpg');
                    	$JPG = ends_with($file->getClientOriginalName(), '.JPG');
						$jpeg = ends_with($file->getClientOriginalName(), '.jpeg');
						$JPEG = ends_with($file->getClientOriginalName(), '.JPEG');
						$png =ends_with($file->getClientOriginalName(), '.png');
						$PNG =ends_with($file->getClientOriginalName(), '.PNG');
						$gif =ends_with($file->getClientOriginalName(), '.gif');
						$GIF =ends_with($file->getClientOriginalName(), '.GIF');


						if($jpg == true)

						$nameonly= str_slug(str_before($file->getClientOriginalName(),'.jpg'), '_');
						...
						$nameonly= str_slug(str_before($file->getClientOriginalName(),'.jpeg'), '_');
						...
						$nameonly= str_slug(str_before($file->getClientOriginalName(),'.png'), '_');
						...
						$nameonly= str_slug(str_before($file->getClientOriginalName(),'.GIF'), '_');

                        $filename = $nameonly . '_' . Str::random(5);
                        $path = $slug.'/'.date('FY').'/';
                        $file->storeAs(
                            $path,
