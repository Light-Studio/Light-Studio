...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.en_posts.update', $dataTypeContent->id) }}@else{{ route('voyager.en_posts.store') }}@endif" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                ...
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id', 'featured', 'image', 'image_alt', 'image_title', 'meta_description', 'meta_keywords', 'seo_title'];
                            @endphp
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              <label  for="image_title">{{ __('voyager.post.image_title') }}</label>


                             <input type="text" class="form-control" name="image_title" value="@if(isset($dataTypeContent->image_title)){{ $dataTypeContent->image_title }}@endif">
                              </div>
                              <div class="form-group">
                              <label for="image_alt">{{ __('voyager.post.image_alt') }}</label>



                            <input type="text" class="form-control" name="image_alt" value="@if(isset($dataTypeContent->image_alt)){{ $dataTypeContent->image_alt }}@endif">
                            </div>
                        </div>
