...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings','translations','voyager_redirects','ltm_translations','permission_groups','permissions'],
        ],
    ],
